...
const obj = {
  ...
  paths: {
    '/api/crm/leads': { get: { operationId: 'getLeads', summary: 'Get Leads', parameters: [ { name: 'page', in: 'query', schema: { type: 'integer' }, required: false }, { name: 'per_page', in: 'query', schema: { type: 'integer' }, required: false } ], responses: { '200': { description: 'Successful CRM response', content: { 'application/json': { schema: { '$ref': '#/components/schemas/CRMResponse' } } } }, '400': { description: 'Bad Request' }, '500': { description: 'Server Error' } } } },
